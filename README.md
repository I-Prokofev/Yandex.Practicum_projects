...
[Исследование данных Q&A-сервиса о программировании](https://github.com/I-Prokofev/Yandex.Practicum_projects/tree/main/Programming%20Q%26A%20data%20research) | Реализация выгрузок из БД,
 хранящей информацию о постах и оценках пользователей сервиса вопросов и ответов о программировании, в соответствии с запросами заказчика | SQL, PostgreSQL
[Опрееделение неэффективных операторов](https://github.com/I-Prokofev/Yandex.Practicum_projects/tree/main/Operators_ineffectiveness_determination) |  | Pandas, Math, Numpy, Plotly, Seaborn, SciPy
